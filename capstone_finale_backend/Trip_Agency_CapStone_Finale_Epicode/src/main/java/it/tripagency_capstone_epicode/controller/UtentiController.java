...
import it.tripagency_capstone_epicode.entity.FakerUtenti;
...
public class UtentiController {
    ...
    private final FakerUtenti fakerUtenti;

    @Autowired
    public UtentiController(UtentiService userService, FakerUtenti fakerUtenti) {
        this.userService = userService;
        this.fakerUtenti = fakerUtenti;
    }
    ...
    @PostMapping("/random")
    public ResponseEntity<Utenti> createRandomUser() {
        Utenti randomUser = userService.createRandomUser();
        return ResponseEntity.status(HttpStatus.CREATED).body(randomUser);
    }
    ...
    public ResponseEntity<Void> generateUsers(@RequestParam("count") int count) {
        fakerUtenti.generaUtenti(count);
