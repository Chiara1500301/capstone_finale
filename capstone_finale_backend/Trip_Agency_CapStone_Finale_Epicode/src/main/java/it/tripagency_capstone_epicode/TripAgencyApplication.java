...
public class TripAgencyApplication {
    ...
    public void initDestinazioni() {
        ...
        destinazione10.setPrezzo(489.0); 
        ...
        destinazione11.setPrezzo(489.0); 
        destinazione11.setPaese("Italia");
        destinazione11.setCitta("Scilla");
        destinazioniRepository.save(destinazione11);
        
        Destinazioni destinazione12 = new Destinazioni();
        destinazione12.setNome("Messico");
        destinazione12.setPrezzo(489.0); 
        ...
        destinazione13.setPrezzo(489.0); 
        ...
        destinazione14.setPrezzo(489.0); 
        ...
        destinazione15.setPrezzo(489.0); 
        destinazione15.setPaese("Tunisia");
        destinazione15.setCitta("NewYork");
